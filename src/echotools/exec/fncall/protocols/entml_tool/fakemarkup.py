...
_TAG_ONLY_OPEN_RES = (
    ...
    re.compile(r"<function_results\b[^>]*>", re.IGNORECASE),
    re.compile(r"<function_result\b[^>]*>", re.IGNORECASE),
...
_TAG_ONLY_CLOSE_RES = (
    ...
    re.compile(r"</function_results\s*>", re.IGNORECASE),
    re.compile(r"</function_result\s*>", re.IGNORECASE),
    re.compile(r"</redacted_thinking\s*>", re.IGNORECASE),
